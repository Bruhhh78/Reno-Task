...
export default function EditNoticePage({ notice }: any) {
  const defaultValues = {
    title: notice.title,
    body: notice.body,
    ...
    <>
      ...
      <div className="container" style={{ maxWidth: "700px" }}>
        <div style={{ marginBottom: "32px", textAlign: "center" }}>
          <h1 style={{ fontSize: "32px", fontWeight: 800, margin: "0 0 12px 0" }}>Edit Notice</h1>
          <p style={{ color: "var(--text-secondary)", margin: 0, fontSize: "16px" }}>Update the details of the notice below.</p>
        </div>
